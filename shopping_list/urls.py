...
from shopping_list.api.views import ListAddShoppingList, ShoppingListDetail, ListAddShoppingItem, ShoppingItemDetail, ShoppingListAddMembers, ShoppingListRemoveMembers
